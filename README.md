...
| --- | --- | --- |
| [**Wraithbane-Showcase**](https://github.com/travisd3v/wraithbane-showcase) | Dark-fantasy boss-rush 2D platformer. Mi primer juego en desarrollo, con sistema de combate preciso de 5 fases, bloqueo (parry), desplazamiento (dash) e integración en tiempo real con TikTok Live mediante Socket.IO. **[Ver showcase público →](https://github.com/travisd3v/wraithbane-showcase)** | Vanilla JS · HTML5 Canvas · Vite · Vitest · pnpm · Node.js · Socket.IO |
...
[![pnpm](https://img.shields.io/badge/pnpm-8.15.9-F69220?style=for-the-badge&logo=pnpm&logoColor=white)](https://pnpm.io/)
...
_Autor: [wraithbane.pro/autor](https://wraithbane.pro/autor) · Proyecto: [github.com/travisd3v/wraithbane-showcase](https://github.com/travisd3v/wraithbane-showcase)_  
